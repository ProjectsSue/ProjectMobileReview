export const en = {
  review: 'review',
  score: 'score',
  bookAddReviewButton: 'Write your Review',
  book: {
    navbar: 'Books',
    navTitle: 'Books',
    navItem: 'Book',
    navNewItem: 'Book Editor',
    navNewComment: 'Comment',
    form: {
      title: 'Name',
      creator: 'Author',
      image: 'Book Image (Cover)',
  ...
  game: {
    ...
    navTitle: 'Games',
    navItem: 'Game',
    navNewItem: 'Game Editor',
    navNewComment: 'Comment',
    form: {
      title: 'Name',
      creator: 'Developer (Company)',
